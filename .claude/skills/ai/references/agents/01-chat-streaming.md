...
> Chat con streaming usando Vercel AI SDK v6 + useChat hook.
...
// SDK v6: importar de @ai-sdk/react
...
export function ChatWidget() {
  // SDK v6: input se maneja externamente
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    setInput('')
    // SDK v6: sendMessage espera { text: string }
    sendMessage({ text })
  }
...
## Cambios Clave SDK v4 vs v6

| v4 (antiguo) | v6 (actual) |
|--------------|-------------|
...
const result = streamText({
  model: google(MODELS.powerful), // Cambiar aqui
  // ...
})
```
